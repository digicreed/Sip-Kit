...
async function migrate() {
  ...
  await db.execute(sql`
    ...
    CREATE INDEX IF NOT EXISTS idx_licenses_provider_id ON licenses(provider_id);
    ...
    CREATE UNIQUE INDEX IF NOT EXISTS idx_devices_unique ON devices(license_id, device_id, app_id);
    CREATE INDEX IF NOT EXISTS idx_refresh_tokens_license_id ON refresh_tokens(license_id);
